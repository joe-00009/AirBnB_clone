...
To see the fundamental background of the project visit the [Wiki](https://github.com/Joe-0009/AirBnB_clone/wiki).
...
```bash
git clone https://github.com/Joe-0009/AirBnB_clone.git
```
...
## Authors
<details>
    <summary>Rachidi Youssef</summary>
    <ul>
    <li><a href="https://www.github.com/Joe-0009">Github</a></li>
    <li><a href="mailto:youssefrachidi1994@gmail.com">e-mail</a></li>
    </ul>
</details>
<details>
